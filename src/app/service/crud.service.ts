...
export class CrudService {
  ...
  addStudents(Students: any): Observable<Students> {
    ...
    return this.http.post<Students>(this.baseURL + 'savestudent.php', body, httpOptions)
  ...
  //colleges
  addCollege(college: any): Observable<Colleges> {
    const httpOptions = {
      headers: new HttpHeaders({
        'content-type': 'application/json'
      }),
    ...
    return this.http.post<Colleges>(this.baseURL + 'savecollege.php', body, httpOptions)
  ...
  updateCollegeInfo(data: Colleges): Observable<Colleges> {
    const httpOptions = {
      headers: new HttpHeaders({
        'content-type': 'application/json'
      }),
    ...
    console.log(body)
    return this.http.post<Colleges>(`${this.baseURL}/postcollegeupdates.php`, body, httpOptions);
  }

  //programs
  addProgram(data: Programs): Observable<Programs> {
    const httpOptions = {
      headers: new HttpHeaders({
        'content-type': 'application/json'
      }),
    ...
    return this.http.post<Programs>(this.baseURL + 'saveprogram.php', body, httpOptions)
  ...
  updateProgramInfo(data: Programs): Observable<Programs> {
    const httpOptions = {
      headers: new HttpHeaders({
        'content-type': 'application/json'
      }),
    ...
    const body = JSON.stringify(data);
    console.log(body)
    return this.http.post<Programs>(`${this.baseURL}postprogramupdates.php`, body, httpOptions);
  }
  ...
  addDepartment(data: Department): Observable<Department> {
    ...
    return this.http.post<Department>(this.baseURL + 'savedepartment.php', body, httpOptions)
  ...
  updateDepartmentInfo(deptData: Department): Observable<Department> {
    const httpOptions = {
      headers: new HttpHeaders({
        'content-type': 'application/json'
      }),
    ...
    console.log(body)
    return this.http.post<Department>(`${this.baseURL}postdepartmentupdate.php`, body, httpOptions);
  }
}
